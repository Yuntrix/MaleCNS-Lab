...
# ============================================================
# MALECNS WORLD VISION BRIDGE V13
#
...
print("=" * 95)
print("MALECNS WORLD VISION BRIDGE V13")
...
last_trigger_ms_by_region = {region: -1000000.0 for region in TRIGGER_ENDPOINTS}
...
with mss.MSS() as screen_capture:
    ...
    print("=" * 95)
    print("VISION BRIDGE V13 ACTIVE")
    print("=" * 95)
    ...
    try:
        ...
        while True:
            ...
            # =================================================
            # COOLDOWN
            # Each region keeps its own 1800 ms cooldown; CENTER cannot block LEFT/RIGHT.
            # =================================================
            ...
            cooldown_ok = (
                ...
                current_ms
                -
                last_trigger_ms_by_region.get(candidate_region, -1000000.0)
            ...
            if confirmed:
                ...
                if queued:
                    ...
                    last_trigger_ms_by_region[candidate_region] = current_ms
            ...
            if frame_start >= next_report:
                ...
                print(
                    ...
                    f" | endpoint={TRIGGER_ENDPOINTS.get(candidate_region, 'NONE')}"
                    f" | cooldown={'READY' if cooldown_ok else 'WAIT'}"
                    f" | latched={event_latches.get(candidate_region, False)}"
                    f" | warmup={not warmup_done}"
                    f" | scene_block={blocked_by_scene_cut}"
                    f" | cap="
