...
# ============================================================
# MALECNS WORLD VISION BRIDGE V11
#
...
print("=" * 95)
print("MALECNS WORLD VISION BRIDGE V11")
...
with mss.MSS() as screen_capture:
    ...
    print("=" * 95)
    print("VISION BRIDGE V11 ACTIVE")
    print("=" * 95)
